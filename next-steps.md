...
1. Modify or add environment variables to configure the running application. Environment variables can be configured by modifying the `env` node in the following files:
    - [app/theCatSaidNo.bicep](./infra/app/theCatSaidNo.bicep)
...
- [app/theCatSaidNo.bicep](./infra/app/theCatSaidNo.bicep) - Azure Container Apps resources to host the 'theCatSaidNo' service.
